...
public class Diric : ITargetArchitecture
{
    ...
    public string StandardCoreLibraryName => "stdlibcore-diric";

    public IRuntimeLibrary RuntimeLibrary => new RuntimeLibraryDiric();

    public ICodeGenBase CodeGenBase => new CodeGenBaseDiric();
