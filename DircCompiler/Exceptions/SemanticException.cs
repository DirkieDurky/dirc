...
public class SemanticException : Exception
{
    ...
    public SemanticException(string message, Token? identifierToken, CompilerOptions compilerOptions, CompilerContext compilerContext) : base(message)
    {
        _message = message;
    ...
    public override string ToString()
    {
        ...
        builder.AppendLine($"SemanticException: {_message} at {tokenString} at {_compilerContext.CurrentFilePath}{lineString}");
